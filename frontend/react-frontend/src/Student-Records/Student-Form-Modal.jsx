      ...
      switch (name) {
        ...
        case "id_number":
          ...
          if (!/^\d{4}-\d{4}$/.test(value) && value.length >= 1) {
            newErrors.id_number =
              "ID number must be in the format NNNN-NNNN. E.g. 2021-1756";
          }
          break;
        default:
          break;
    ...
    <div className="modal">
      ...
      <div className={"form"}>
        <div className="form-group">
          ...
          />
          {errors.full_name && (
            <span className="error-name">{errors.full_name}</span>
          )}
        </div>
        ...
        <div className="form-group">
          ...
          />
          {errors.id_number && (
            <span className="error-name">{errors.id_number}</span>
          )}
        </div>
        ...
        <div className="form-buttons">
          <button
            ...
            onClick={async () => {
              if (purpose === "Edit") {
                formData.original_id = student?.id_number;
              }
              ...
              if (submitSuccess) {
                setStudents((prevStudents) => {
                  ...
                  if (purpose === "Edit") {
                    updatedStudents[student.number] = {
                      ...updatedStudents[student.number],
                      ...formData,
