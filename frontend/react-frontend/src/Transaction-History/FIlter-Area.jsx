export default function FilterArea({ programCodes, setFilterParams }) {
    const display_status = ["All", "Pending", "Accepted"];
    ...
    return (
        <div id="filter-records" className="card">
            ...
            <select name="filter-status" id="filter-status" className="filter-selection" title="Filter Status" 
                onChange={(e) => {setFilterParams((params) => {return {...params, statusFilter: e.target.value}})}}>
