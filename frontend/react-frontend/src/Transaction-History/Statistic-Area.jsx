export default function StatisticsArea({contributions, choosenContribution, setters}) {   
    const contributionSelector = (
        <div id="contribution-info" className="card">
            ...
            <select name="selected-contribution" id="selected-contribution" className="filter-selection" 
            onChange={(e) => { choosenContribution.fetchHistory(e.target.value, setters) }}
            >
